  ...
  const jobs = [
    {
      ...
      postedAt: "2 days ago",
      description:
        "We're looking for a React expert to lead our frontend team in building high-performance AI dashboards...",
    ...
    },
    {
      ...
      description:
        "Join our design studio to create world-class mobile experiences for global brands...",
    ...
    },
    {
      ...
      postedAt: "1 day ago",
      description:
        "Lead the architecture of our distributed data processing engine using Node.js and Rust...",
      skills: ["Node.js", "Rust", "PostgreSQL", "AWS"],
      logo: "DS",
      matchScore: 74,
    },
    {
      ...
      postedAt: "3 days ago",
      description:
        "Automate our infrastructure and scale our Kubernetes clusters across multiple regions...",
          ...
          <aside className="lg:col-span-3 space-y-6">
            <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm p-6">
              <div className="flex items-center justify-between mb-6">
                ...
                <button className="text-[12px] font-bold text-wise-green hover:underline">
                  Reset All
                </button>
              </div>
          ...
          <section className="lg:col-span-6 space-y-6">
            <div className="flex items-center justify-between mb-4 px-2">
              <p className="text-[14px] text-gray-500 font-medium">
                Showing <span className="text-gray-900 font-bold">124</span>{" "}
