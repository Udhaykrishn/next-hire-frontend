...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col font-satoshi selection:bg-wise-green selection:text-dark-green relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] left-[-10%] size-[50%] rounded-full bg-wise-green/10 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] size-[60%] rounded-full bg-blue-400/5 blur-[150px] pointer-events-none" />
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 size-[35%] rounded-full bg-emerald-400/5 blur-[100px] pointer-events-none" />
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 relative z-10">
        <div className="max-w-xl w-full text-center gap-y-10 bg-white/70 backdrop-blur-2xl border border-gray-100 p-10 md:p-14 rounded-[3.5rem] shadow-xl shadow-gray-200/30">
          {/* Glowing Animated Compass */}
          <div className="mx-auto size-24 rounded-[2.5rem] bg-wise-green/10 text-wise-green flex items-center justify-center border border-wise-green/20 relative shadow-lg shadow-wise-green/5 animate-pulse duration-[4000ms]">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            <Link
              href="/profile"
              className="w-full sm:w-auto h-12 px-8 rounded-2xl bg-gray-900 text-white hover:bg-gray-950 hover:shadow-lg hover:shadow-gray-900/10 transition-all text-[13px] font-black flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-[0.98]"
            >
