    ...
    <div className="bg-[#ffffff] p-8 rounded-[20px] border border-[rgba(14,15,12,0.08)] shadow-sm">
      ...
      <div className="flex flex-wrap gap-2.5">
        {skills.map((skill: string, idx: number) => (
          <span key={idx} className="px-4 py-2 bg-[#f4f6f3] border border-[rgba(14,15,12,0.08)] text-[#0e0f0c] font-[600] text-[14px] rounded-full hover:bg-[#e8ebe6] transition-colors">
            {skill}
          </span>
        ))}
      </div>
