    ...
    <div className="bg-[#ffffff] p-8 rounded-[20px] border border-[rgba(14,15,12,0.08)] shadow-sm">
      ...
      {experience && experience.length > 0 ? (
          ...
          {experience.map((exp, idx: number) => (
            ...
            >
              <div className="flex items-center justify-center size-12 rounded-full bg-[#f4f6f3] border-2 border-[#ffffff] shadow-sm z-10 shrink-0">
                <Briefcase className="size-5 text-[#054d28]" />
              </div>
              <div className="bg-[#f9faf9] p-6 rounded-[16px] border border-[rgba(14,15,12,0.05)] w-full hover:shadow-sm transition-shadow">
                <div className="flex flex-col md:flex-row md:items-start justify-between gap-2 mb-2">
                  <div>
                    ...
                    <p className="text-[15px] font-[600] text-[#054d28]">
                ...
                {exp.description && (
                  <p className="text-[15px] text-[#454745] leading-relaxed mb-4">
                    {exp.description}
                  </p>
                )}
        ...
        <div className="bg-[#f9faf9] p-8 rounded-[16px] border border-[rgba(14,15,12,0.05)] text-center">
          <Briefcase className="size-8 text-[#868685] mx-auto mb-3 opacity-50" />
