            ...
            <div className="flex items-center gap-4 border-l border-gray-100 pl-8">
              {isAuthenticated ? (
                <div className="relative group">
                  ...
                  >
                    <div className="size-8 rounded-full bg-wise-green flex items-center justify-center text-dark-green font-black text-xs">
                      {user?.fullName?.charAt(0) ||
                        user?.email.charAt(0).toUpperCase()}
                    </div>
                    <ChevronDown className="size-4 text-gray-400 mr-2 group-hover:rotate-180 transition-transform" />
                  </button>
