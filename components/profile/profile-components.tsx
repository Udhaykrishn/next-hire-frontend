      ...
      <div className="flex items-center justify-between mb-8">
        ...
        {href ? (
          <Link
            ...
            title={`Add to ${title}`}
            className="w-10 h-10 rounded-full bg-gray-50 flex items-center justify-center text-gray-400 hover:text-wise-green hover:bg-wise-green/10 transition-all border border-gray-100 focus-visible:ring-2 focus-visible:ring-wise-green focus-visible:outline-none"
          >
              ...
              <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
                {editHref && (
                  <Link
                    ...
                    title={`Edit ${title}`}
                    className="p-1.5 rounded-lg hover:bg-wise-green/10 text-gray-400 hover:text-wise-green transition-colors focus-visible:ring-2 focus-visible:ring-wise-green focus-visible:outline-none"
                  >
                ...
                {onDeleteClick && (
                  <button
                    ...
                    title={`Delete ${title}`}
                    className="p-1.5 rounded-lg hover:bg-red-50 text-gray-400 hover:text-red-500 transition-colors focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none"
                  >
