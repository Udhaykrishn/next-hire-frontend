  ...
  return (
    <header className="h-16 bg-white/80 backdrop-blur-md border-b border-gray-50 flex items-center justify-between px-8 sticky top-0 z-40">
      ...
      <div className="flex items-center gap-4">
        ...
        >
          <Bell className="size-5 group-hover:rotate-12 duration-300" />
          <span className="absolute top-2 right-2 size-2 bg-wise-green border-2 border-white rounded-full" />
        </button>
        ...
        <div className="flex items-center gap-3 pl-4 border-l border-gray-100 cursor-pointer group">
          ...
          <div className="size-10 rounded-xl bg-near-black text-white flex items-center justify-center font-black text-sm transition-transform group-hover:scale-105 shadow-lg shadow-near-black/10">
            A
          </div>
        </div>
      </div>
